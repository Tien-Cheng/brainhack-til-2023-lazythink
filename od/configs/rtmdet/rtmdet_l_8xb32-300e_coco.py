...
val_dataloader = dict(
    batch_size=4, num_workers=2, dataset=dict(pipeline=test_pipeline)
)
...
# use pre-trained checkpoint for finetuning
load_from = (
    "https://download.openmmlab.com/mmdetection/v3.0/rtmdet/"
    "rtmdet_l_8xb32-300e_coco/rtmdet_l_8xb32-300e_coco_20220719_112030"
    "-5a0be7c4.pth"
)
